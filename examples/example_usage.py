    ...
    sample_reports = [
        {
            ...
            "description": (
                "Users are experiencing timeouts when trying to connect to the PostgreSQL database. "
                "The application becomes unresponsive after 30 seconds."
            ),
        ...
        },
        {
            ...
            "description": (
                "The main dashboard component is not rendering properly for users on mobile devices. "
