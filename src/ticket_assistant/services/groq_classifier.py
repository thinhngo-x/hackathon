...
import json
import logging
from ticket_assistant.core.models import Department, ErrorSeverity, ClassificationResponse
...
class GroqClassifier:
    ...
    async def classify_error(self, error_description: str, error_message: str = None, context: str = None) -> ClassificationResponse:
        """
        ...
        try:
            ...
            chat_completion = self.client.chat.completions.create(
                messages=[
                    {
                        "role": "system",
                        "content": "You are an expert technical support classifier. Analyze errors and route them to the appropriate department."
                    },
                    {
                        "role": "user",
                        "content": prompt
            ...
            logger.error(f"Error in Groq classification: {str(e)}")
    ...
    def _build_classification_prompt(self, error_description: str, error_message: str = None, context: str = None) -> str:
